...
class Game():
    ...
    def __init__(self, w, h, mapw, maph):
        ...
        self.player3 = Player(450, 50, 36, 48, 'Images/red.png', 'Images/redDead.png')  # Initializing Player class instance at set point(300,300) in map # p3
        ...
        self.p3Label = Label(1030, 345, "Player3 has joined", 20, self.lobby) #p3
    ...
    def run(self):
        ...
        self.add_player(self.player3) #p3
        ...
        while running:
            ...
            self.player3.x, self.player2.y = self.parseData(self.sendData()) #p3
            ...
            self.player3.draw(self.lobby.getLobby()) #p3
    ...
    def rungame(self):
        ...
        while running:
            ...
            # Send Network data
            self.player2.x, self.player2.y = self.parseData(self.sendData())
            self.player3.x, self.player3.y = self.parseData(self.sendData()) # p3
            # Update map
            self.map.drawMapBackground()
            self.player1.draw(self.map.getMap())
            self.player2.draw(self.map.getMap())
            self.player3.draw(self.map.getMap()) #p3
